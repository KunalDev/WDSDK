...
open class WDSDKKeychainWrapper {
    ...
    private static let defaultServiceName: String = {
        return "com.walletdoc.business"
        //return Bundle.main.bundleIdentifier ?? "SwiftKeychainWrapper"
    }()
    
    private convenience init() {
        //self.init(serviceName: WDSDKKeychainWrapper.defaultServiceName)
        self.init(serviceName: WDSDKKeychainWrapper.defaultServiceName, accessGroup: "5S9PE2N348.com.walletdoc.business")
    }
