//
//  WDProcessTransactionOperation.swift
//  walletdoc
//
...
class WDProcessTransactionOperation: WDSDKConcurrentOperation<WDProcessTransactionResponse,Error> {
    ...
    override func main() {
        ...
        task = session.dataTask(with: urlRequest) { (data, response, error) in
            ...
            do {
                ...
                let processTransactionResponse = try decoder.decode(WDProcessTransactionResponse.self, from: responseData)
